...
class SpeakersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create speaker" do
    assert_difference("Speaker.count") do
      post speakers_url, params: { speaker: { email: @speaker.email, first_name: @speaker.first_name, last_name: @speaker.last_name, url: @speaker.url } }
    end
  ...
  test "should update speaker" do
    patch speaker_url(@speaker), params: { speaker: { email: @speaker.email, first_name: @speaker.first_name, last_name: @speaker.last_name, url: @speaker.url } }
