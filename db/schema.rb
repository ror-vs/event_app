...
ActiveRecord::Schema.define(version: 2022_01_11_120239) do
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.boolean "all_day"
    t.datetime "publish_on", precision: 6
    t.datetime "unpublish", precision: 6
    t.string "submission_faq"
    t.datetime "submission_due_date", precision: 6
    t.datetime "speaker_notified_dat", precision: 6
    t.boolean "published"
    t.boolean "feature"
    t.boolean "internal"
